        ...
        {isOpen && (
          ...
          >
            <div className="px-4 pt-4 pb-6 space-y-3">
              ...
              >
                <button 
                  className="flex items-center w-full text-left px-4 py-3 rounded-lg text-base font-medium text-white bg-primary hover:bg-primary/90 shadow-md hover:shadow-lg mt-2"
                  onClick={() => {
                    handleRandomRecipe();
                    setIsOpen(false);
                  }}
